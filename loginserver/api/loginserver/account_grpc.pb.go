...
func (c *accountClient) CreateAccount(ctx context.Context, in *CreateAccountRequest, opts ...grpc.CallOption) (*CreateAccountReply, error) {
	...
	err := c.cc.Invoke(ctx, "/api.loginserver.Account/CreateAccount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accountClient) LoginAccount(ctx context.Context, in *LoginAccountRequest, opts ...grpc.CallOption) (*LoginAccountReply, error) {
	out := new(LoginAccountReply)
	err := c.cc.Invoke(ctx, "/api.loginserver.Account/LoginAccount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAccountServer) LoginAccount(context.Context, *LoginAccountRequest) (*LoginAccountReply, error) {
...
func _Account_CreateAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.loginserver.Account/CreateAccount",
	}
...
func _Account_LoginAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.loginserver.Account/LoginAccount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccountServer).LoginAccount(ctx, req.(*LoginAccountRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Account_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.loginserver.Account",
	...
	Metadata: "api/loginserver/account.proto",
}
